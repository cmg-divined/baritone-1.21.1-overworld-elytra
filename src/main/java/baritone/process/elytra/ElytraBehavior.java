...
public final class ElytraBehavior implements Helper {
    ...
    public void onChunkEvent(ChunkEvent event) {
        if (event.isPostPopulate() && this.context != null) {
            ...
            this.context.queueForPacking(chunk, this.boi);
        }
    }
    ...
    // Fix destination to avoid trying to pathfind through the roof in different dimensions
    private BetterBlockPos fixDestination(BetterBlockPos dst) {
        if (ctx.world().dimension() == net.minecraft.world.level.Level.NETHER) {
